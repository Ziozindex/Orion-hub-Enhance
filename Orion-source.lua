...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			-- Increased contrast for TextDark
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.OpenIcon = WindowConfig.OpenIcon or "rbxassetid://8834748103"
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		-- Set background transparency to 0 for solid theme color
		BackgroundTransparency = 0
	}), {
...
ImageButton.Image = WindowConfig.OpenIcon
...
if UserInputService.KeyboardEnabled then
    OrionLib:MakeNotification({
        Name = "PC User",
        Content = "Click Right Shift to show the UI again",
...
ImageButton.Visible = false
    ...
    OrionLib:MakeNotification({
        Name = "Phone User",
        Content = "Click on the icon to open the UI again",
        Image = "rbxassetid://8834748103",
        Time = 7
    })
ImageButton.Visible = true
	...
	function TabFunction:MakeTab(TabConfig)
		...
		function ElementFunction:AddSection(SectionConfig)
			...
			local SectionFrame = SetChildren(SetProps(MakeElement("TFrame"), {
				...
				-- Made section header font bold for better hierarchy
